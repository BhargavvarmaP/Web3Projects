export namespace getOrSetResource {
    namespace options {
        namespace payload {
            const parse: boolean;
            const output: string;
        ...
        const pre: {
             ...
             */
            method: (request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, _h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>) => {
                key: string;
                value: any;
            } | {
                key: any;
     ...
     */
    function handler(request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>): Promise<import("@hapi/hapi").ResponseObject>;
    /**
     * @param {import('../../types').Request} request
     * @param {import('@hapi/hapi').ResponseToolkit} h
     */
...
export namespace getResource {
    ...
    export function handler(request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>): Promise<import("@hapi/hapi").ResponseObject>;
}
export namespace showResource {
    ...
    export function handler_1(request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>): Promise<import("@hapi/hapi").ResponseObject>;
    export { handler_1 as handler };
}
export namespace replaceResource {
    export namespace options_6 {
        ...
        const pre_1: {
             ...
             * @param {import('@hapi/hapi').ResponseToolkit} _h
             */
            method: (request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, _h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>) => Promise<{
                config: any;
            }>;
        }[];
        export { pre_1 as pre };
...
export namespace profilesApplyResource {
    ...
    export function handler_2(request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>): Promise<import("@hapi/hapi").ResponseObject>;
    export { handler_2 as handler };
}
export namespace profilesListResource {
    ...
    export function handler_3(request: import("@hapi/hapi").Request<import("@hapi/hapi").ReqRefDefaults>, h: import("@hapi/hapi").ResponseToolkit<import("@hapi/hapi").ReqRefDefaults>): Promise<import("@hapi/hapi").ResponseObject>;
