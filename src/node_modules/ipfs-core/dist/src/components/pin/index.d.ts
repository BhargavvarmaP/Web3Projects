export class PinAPI {
    ...
    rmAll: (source: import("ipfs-core-types").AwaitIterable<import("ipfs-core-types/src/pin/index.js").RmAllInput>, _options?: import("ipfs-core-types").AbortOptions | undefined) => AsyncIterable<import("multiformats").CID<unknown, number, number, import("multiformats").Version>>;
    rm: (path: string | import("multiformats").CID<unknown, number, number, import("multiformats").Version>, options?: import("ipfs-core-types/src/pin/index.js").RmOptions | undefined) => Promise<import("multiformats").CID<unknown, number, number, import("multiformats").Version>>;
