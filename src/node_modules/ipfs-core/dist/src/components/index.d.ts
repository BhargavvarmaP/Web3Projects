...
declare class IPFS {
    ...
    ipns: IPNSAPI;
    pin: PinAPI;
    resolve: (path: string, opts?: import("ipfs-core-types/src/root.js").ResolveOptions | undefined) => Promise<string>;
    block: BlockAPI;
    ...
    version: (_options?: import("ipfs-core-types").AbortOptions | undefined) => Promise<import("ipfs-core-types/src/root.js").VersionResult>;
    bitswap: BitswapAPI;
    ...
    config: {
        ...
        replace: (value: import("ipfs-core-types/src/config/index.js").Config, options: import("ipfs-core-types").AbortOptions | undefined) => Promise<void>;
        profiles: {
            apply: (profileName: string, options?: import("ipfs-core-types/src/config/profiles/index.js").ProfilesApplyOptions | undefined) => Promise<import("ipfs-core-types/src/config/profiles/index.js").ProfilesApplyResult>;
            list: (_options: import("ipfs-core-types").AbortOptions | undefined) => Promise<import("ipfs-core-types/src/config/profiles/index.js").Profile[]>;
        };
    };
