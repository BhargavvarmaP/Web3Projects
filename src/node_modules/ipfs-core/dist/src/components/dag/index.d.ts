export class DagAPI {
    ...
    put: (dagNode: any, options?: import("ipfs-core-types/src/dag/index.js").PutOptions | undefined) => Promise<import("multiformats").CID<unknown, number, number, import("multiformats").Version>>;
}
