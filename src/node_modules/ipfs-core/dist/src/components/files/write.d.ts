 ...
 */
export function createWrite(context: MfsContext): (path: string, content: string | Uint8Array | AsyncIterable<Uint8Array> | Iterable<Uint8Array> | Blob, opts?: import("ipfs-core-types/src/files").WriteOptions | undefined) => Promise<void>;
...
export type DefaultOptions = {
    ...
    mtime?: import("ipfs-unixfs/dist/src/types.js").MtimeLike | undefined;
