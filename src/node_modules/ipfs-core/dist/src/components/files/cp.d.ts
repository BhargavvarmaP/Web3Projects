 ...
 */
export function createCp(context: MfsContext): (from: import("ipfs-core-types/src/utils.js").IPFSPath | import("ipfs-core-types/src/utils.js").IPFSPath[], to: string, opts?: import("ipfs-core-types/src/files").CpOptions | undefined) => Promise<void>;
