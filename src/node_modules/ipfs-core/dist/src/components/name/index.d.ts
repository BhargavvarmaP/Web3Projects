export class NameAPI {
    ...
    resolve: (name: string | import("@libp2p/interface-peer-id").PeerId, options?: import("ipfs-core-types/src/name/index.js").ResolveOptions | undefined) => AsyncIterable<string>;
    pubsub: PubSubAPI;
}
